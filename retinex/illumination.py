...
def estimate_illumination(img_log, method='gaussian', ksize=15, sigma=30):  # (ksize=7, sigma=2), (ksize=15, sigma=5), (ksize=31, sigma=15), (ksize=51, sigma=25) / original -> (15, 30)
    ...
    for c in range(3):
        if method == 'gaussian':
            ...
            filtered = cv2.bilateralFilter(norm, d=31, sigmaColor=100, sigmaSpace=20)       # (d, sigmaColor, sigmaSpace) = (7, 25, 5), (15, 50, 10), (31, 100, 20) / original -> norm, d=9, sigmaColor=75, sigmaSpace=75
...
def main():
    ...
    for method in ['gaussian', 'bilateral']:
        ...
        # Save outputs
        save_image(reflectance, f'Files/reflectance_31_100_20{method}.png')
        save_image(illum_rgb, f'Files/illumination_31_100_20{method}.png')
